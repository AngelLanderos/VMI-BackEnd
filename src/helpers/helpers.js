...
export function generatePassword(
  length = 12,
  options = { mayus: true, minus: true, numbers: true, symbols: true },
) {
  const charts = {
...
export const sendASN = async (asnInformation) => {
  try {
    ...
    const response = await axios.post(
      `https://wmsvantec.com.mx:3001/ASN/CreateNewASNFromVMI`,
      {
